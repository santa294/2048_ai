...
/**
 * Класс решателей с искусственным интеллектом, который использует
 * искусственный интеллект для оценки следующего шага.
 */
public class AIsolver {
    
    /**
     * Класс перечисления Игрок против компьютера
     */
    public enum Player {
        /**
         * Компьютер
    ...
    /**
     * Метод, который находит наилучший следующий ход.
     */
    ...
    /**
     * Находит наилучший ход с помощью минимаксного алгоритма.
        ...
        if(depth==0 || theBoard.isGameTerminated()) {
            ...
            if(player == Player.USER) {
                ...
                for(Direction direction : Direction.values()) {
                    ...
                    if(currentScore>bestScore) { //максимизировать балл
    ...
    /**
     * Находит наилучший ход, используя алгоритм альфа-бета-обрезки.
     */
    ...
    /**
     * Оценивает эвристический балл, принимая во внимание реальный балл,
     * количество пустых ячеек и оценку кластеризации доски.
     */
    ...
    /**
     * Вычисляет эвристическую оценку, подобную дисперсии,
     * которая измеряет степень кластеризации доски.
     */
